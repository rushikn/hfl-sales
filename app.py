...
def results_to_natural_language(results, user_query):
    ...
    "Do not skip, alter, abbreviate, interpret, — preserve full spelling, digits, and formatting.\n"
    ...
    "strictly follow this: never ever include '$'"
    ...
    "Always round all decimal values (including percentages) to exactly 2 decimal places, rounding up if needed (e.g., 0.39 → 0.40).\n"
    "display every thing present in the sql result in meaning ful way, do not skip.\n"
    ...
    "Always round all decimal values (including percentages) to exactly 2 decimal places, rounding up if needed (e.g., 0.39 → 0.40).\n"
    "display every thing present in the sql result in meaning ful way , do not skip even last line also dont skip.\n"
